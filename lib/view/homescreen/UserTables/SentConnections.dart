...
class SentConnections extends StatefulWidget {
  ...
  SentConnections({required this.username});
  @override
  _SentConnectionsState createState() => _SentConnectionsState();
}
...
class _SentConnectionsState extends State<SentConnections> {
  ...
  Future<void> loadData() async {
    await userController.goToSentconnectionsUsers(widget.username);
    setState(() {
      isLoading = false;
    });
  }
  ...
  Widget build(BuildContext context) {
    int tempUserCount = userController.SentconnectionsUserData.length;
                ...
                children: [
                  ...
                  SingleChildScrollView(
                    ...
                    child: DataTable(
                      ...
                      rows: userController.SentconnectionsUserData
                          .where(
  (user) =>
      user['username']!
          .toLowerCase()
