...
class _JobsPageState extends State<JobsPage> {
  ...
  void initState() {
    super.initState();
    pageController.goToJobs(widget.pageId).then((_) {
      setState(() {
        isLoading = false;
      });
    });
  ...
  Widget build(BuildContext context) {
    ...
    int jobsCount = pageController.jobsData.length;

    return Scaffold(
      appBar: AppBar(
        title: Text("Page Jobs"),
      ),
