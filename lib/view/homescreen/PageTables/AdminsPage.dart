...
class PageAdmins extends StatefulWidget {
  ...
  PageAdmins({required this.pageId});
  @override
  _PageAdminsState createState() => _PageAdminsState();
}

class _PageAdminsState extends State<PageAdmins> {
  ...
  Future<void> loadData() async {
    await pageController.goToTempUsers(widget.pageId);
    setState(() {
      isLoading = false;
    });
  }
  ...
  Widget build(BuildContext context) {
    int tempUserCount = pageController.tempUserData.length;

    return Scaffold(
      appBar: AppBar(
        title: Text("Page Admins"),
      ),
      body: isLoading
                ...
                children: [
                  ...
                  SingleChildScrollView(
                    ...
                    child: DataTable(
                      ...
                      rows: pageController.tempUserData
                          .where(
  (user) =>
      user['username']!
          .toLowerCase()
